			...
			for time,val in x_y_pairs:
				...
				if x_y_pairs[-1]==(time,val):
			        ...
			        if previous_val!=val:
                                        ...
                                        bus_val=''
				json_string=json_string+'{"x":'+str(time/1000000)+',"y":'+str(bus_bit+voltage_val)+',"indexLabel": "'+bus_val+'","indexLabelLineThickness":1,"indexLabelMaxWidth": 1, "indexLabelPlacement": "inside","indexLabelFontSize": 14,"indexLabelFontColor": "black"}'
